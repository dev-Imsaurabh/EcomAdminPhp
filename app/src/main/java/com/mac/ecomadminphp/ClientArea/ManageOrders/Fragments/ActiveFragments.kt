...
class ActiveFragments : Fragment() {
    private lateinit var _binding: FragmentActiveFragmentsBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentActiveFragmentsBinding.inflate(layoutInflater)
                ...
                try {
                    ...
                    if(success.equals("1")){
                        for(item in 0 until jsonArray.length()){
                            ...
                            val data = CommonOrderModel(id,orderId,total,status,orderManagerId,paymentMode,"0",dc)
